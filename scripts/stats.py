...
RISK_FUNNELS = {
    ...
    "funding": [("≥ 1 funding channel", "gt0", "channels_count"),
                ("Funding link present (`has_funding_link`)", "bool", "has_funding_link"),
                ("GitHub Sponsors inbound > 0", "gt0", "gh_sponsors_in"),
                ...
                ("Org-fundable owner (`org_fundable`)", "bool", "org_fundable")],
