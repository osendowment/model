...
Usage:
    uv run python -m src.ecosystems.packages
    uv run python -m src.ecosystems.packages --eco cpp --limit 20
    uv run python -m src.ecosystems.packages --ttl 0           # force refresh
"""
