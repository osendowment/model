...
Why this exists:
    `src/git/fetch_scc.py` (scc) gives a fast keyword-count "complexity" that
...
Usage:
    uv run python -m src.github.fetch_cognitive --limit 10
    uv run python -m src.github.fetch_cognitive --limit 0   # full set
    uv run python -m src.github.fetch_cognitive --repos a/b c/d
"""
