...
Run:
    uv run src/sources/npm/process_data.py
    uv run src/sources/npm/process_data.py --ignore-gaps   # skip fetching, use what's available
    uv run src/sources/npm/process_data.py --concurrency 20
"""
