...
Run:
    uv run src/sources/pypi/process_data.py
    uv run src/sources/pypi/process_data.py --min-avg 500000   # override cumulative threshold
    uv run src/sources/pypi/process_data.py --alpha 0.90
"""
