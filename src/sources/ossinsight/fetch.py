...
Usage:
    uv run python -m src.sources.ossinsight.fetch --limit 5
    uv run python -m src.sources.ossinsight.fetch --limit 5 --concurrency 4
    uv run python -m src.sources.ossinsight.fetch  # all risk repos
"""
