...
Usage:
    ...
    uv run python -m src.sources.github.fetch_repo_owner_data --target repos
    uv run python -m src.sources.github.fetch_repo_owner_data --target users
    uv run python -m src.sources.github.fetch_repo_owner_data --limit 20
    uv run python -m src.sources.github.fetch_repo_owner_data --force
    uv run python -m src.sources.github.fetch_repo_owner_data --classes A B C
"""
