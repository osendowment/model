...
Usage:
    uv run python -m src.npm.fetch_licenses                # cached + apply
    uv run python -m src.npm.fetch_licenses --force        # ignore TTL
    uv run python -m src.npm.fetch_licenses --apply-only   # skip API, just join cache → results.csv
    uv run python -m src.npm.fetch_licenses --limit 100
    uv run python -m src.npm.fetch_licenses --concurrency 30
"""
