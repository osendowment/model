...
Run:
    uv run src/debian/fetch_debian_data.py              # all steps
    uv run src/debian/fetch_debian_data.py --step popcon
    uv run src/debian/fetch_debian_data.py --years 2023 2024 2025
