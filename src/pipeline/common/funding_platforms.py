...
Shared by the FUNDING.yml fetcher (`src.github.fetch_funding_yml`), the FLOSS
Fund export parser (`src.floss_fund.funding_json`), and the funding builder
(`src.pipeline.risk.build_funding`). FUNDING.yml uses these keys directly;
