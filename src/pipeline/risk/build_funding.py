...
Note: funding-data.csv also carries `funding_5y` (funding.json declared
2021-2025 income), but it is not surfaced in this dimension — it is
empty for every in-scope repo (no repo's funding.json declares a
`funding.history`).
