...
TOP_CSV     = "data/sources/crates/top-packages.csv"
DEPS_CSV    = "data/sources/crates/dependency-tree.csv"
GITHUB_CSV  = "data/sources/crates/github-repos.csv"
RESULTS_CSV = "data/sources/crates/results.csv"
