...
The final **`risk.csv` ranks 887** of them: **8 company-backed repos** (a company —
Meta, Google, … — already resources them, so not endowment funding candidates)
are dropped at aggregation. Methodology: [risk.md](risk.md) + component docs.
