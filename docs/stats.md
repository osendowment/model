...
| · from GitHub | 22 | 2.4% |
| **oss=True (OSI-approved)** | **895** | **97.7%** |
...
| Category | Repos | % |
|---|---:|---:|
| intent — any funding signal | 630 | 68.8% |
| intent — no funding signal | 286 | 31.2% |
| nonprofit — community / independent | 883 | 96.4% |
| nonprofit — company-backed | 33 | 3.6% |
