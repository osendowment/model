...
| <img src="https://www.google.com/s2/favicons?domain=isocpp.org&sz=16" width="16"> [cpp](components/cpp.md) (derived rollup) | blended downloads score, dep tree, PageRank classes | Debian package list for OSV queries | license join; `eol.csv` verdicts |
