...
| <img src="https://www.google.com/s2/favicons?domain=github.com&sz=16" width="16"> [github](sources/github.md) | repo identity/validation, stars, `mirror_url` | SHA anchors, issue metrics | `archived` flag; license fallback; Sponsors + FUNDING.yml |
...
| <img src="https://www.google.com/s2/favicons?domain=git-scm.com&sz=16" width="16"> [git](sources/git.md) (local clones) | — | complexity (LOC, cyclomatic, cognitive), concentration (bus factor/HHI), workload cadence | — |
